...
def validate_input_file_format(input_file):
...
def main():
    ...
    if not validate_input_file_format(input_file):
...
# python reader_corrected-3.py in.csv out-2.csv 0,0,gitara 3,1,kubek 1,2,17 3,3,0
